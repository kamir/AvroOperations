 ...
 */
package io.confluent.examples.clients.basicavro_345;
...
public class Payment extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3113096613822624438L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Payment\",\"namespace\":\"io.confluent.examples.clients.basicavro_345\",\"doc\":\"v2b\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"double\"},{\"name\":\"region\",\"type\":\"string\",\"default\":\"OLD\"}]}");
   ...
   */
  public static io.confluent.examples.clients.basicavro_345.Payment.Builder newBuilder() {
    return new io.confluent.examples.clients.basicavro_345.Payment.Builder();
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static io.confluent.examples.clients.basicavro_345.Payment.Builder newBuilder(io.confluent.examples.clients.basicavro_345.Payment.Builder other) {
    return new io.confluent.examples.clients.basicavro_345.Payment.Builder(other);
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static io.confluent.examples.clients.basicavro_345.Payment.Builder newBuilder(io.confluent.examples.clients.basicavro_345.Payment other) {
    return new io.confluent.examples.clients.basicavro_345.Payment.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Payment>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.confluent.examples.clients.basicavro_345.Payment.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.confluent.examples.clients.basicavro_345.Payment other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.examples.clients.basicavro_345.Payment.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.examples.clients.basicavro_345.Payment.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.examples.clients.basicavro_345.Payment.Builder setAmount(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.examples.clients.basicavro_345.Payment.Builder clearAmount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.examples.clients.basicavro_345.Payment.Builder setRegion(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.examples.clients.basicavro_345.Payment.Builder clearRegion() {
      region = null;
