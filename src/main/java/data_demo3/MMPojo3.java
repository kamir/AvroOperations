...
public class MMPojo3 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3086377204848224449L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MMPojo3\",\"namespace\":\"data_demo3\",\"doc\":\"Schema for MMPojo3\",\"fields\":[{\"name\":\"dateSent\",\"type\":[\"null\",\"string\"]},{\"name\":\"nrOfReciepients\",\"type\":\"int\"},{\"name\":\"receiver\",\"type\":[\"null\",\"string\"]},{\"name\":\"sender\",\"type\":[\"null\",\"string\"]},{\"name\":\"size\",\"type\":[\"null\",\"string\"]},{\"name\":\"subject\",\"type\":[\"null\",\"string\"]}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<MMPojo3> ENCODER =
      new BinaryMessageEncoder<MMPojo3>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<MMPojo3> DECODER =
      new BinaryMessageDecoder<MMPojo3>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<MMPojo3> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<MMPojo3> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<MMPojo3>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this MMPojo3 to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a MMPojo3 from a ByteBuffer. */
  public static MMPojo3 fromByteBuffer(
   ...
   */
  public MMPojo3(java.lang.CharSequence dateSent, java.lang.Integer nrOfReciepients, java.lang.CharSequence receiver, java.lang.CharSequence sender, java.lang.CharSequence size, java.lang.CharSequence subject) {
  ...
  /**
   * Creates a new MMPojo3 RecordBuilder.
   * @return A new MMPojo3 RecordBuilder
   */
  public static data_demo3.MMPojo3.Builder newBuilder() {
    return new data_demo3.MMPojo3.Builder();
  }

  /**
   * Creates a new MMPojo3 RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new MMPojo3 RecordBuilder
   */
  public static data_demo3.MMPojo3.Builder newBuilder(data_demo3.MMPojo3.Builder other) {
    return new data_demo3.MMPojo3.Builder(other);
  }

  /**
   * Creates a new MMPojo3 RecordBuilder by copying an existing MMPojo3 instance.
   * @param other The existing instance to copy.
   * @return A new MMPojo3 RecordBuilder
   */
  public static data_demo3.MMPojo3.Builder newBuilder(data_demo3.MMPojo3 other) {
    return new data_demo3.MMPojo3.Builder(other);
  }

  /**
   * RecordBuilder for MMPojo3 instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MMPojo3>
    implements org.apache.avro.data.RecordBuilder<MMPojo3> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(data_demo3.MMPojo3.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing MMPojo3 instance
     * @param other The existing instance to copy.
     */
    private Builder(data_demo3.MMPojo3 other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.dateSent)) {
        this.dateSent = data().deepCopy(fields()[0].schema(), other.dateSent);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public data_demo3.MMPojo3.Builder setDateSent(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public data_demo3.MMPojo3.Builder clearDateSent() {
      dateSent = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public data_demo3.MMPojo3.Builder setNrOfReciepients(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public data_demo3.MMPojo3.Builder clearNrOfReciepients() {
    ...
    /**
      ...
      * @return This builder.
      */
    public data_demo3.MMPojo3.Builder setReceiver(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public data_demo3.MMPojo3.Builder clearReceiver() {
      receiver = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public data_demo3.MMPojo3.Builder setSender(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public data_demo3.MMPojo3.Builder clearSender() {
      sender = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public data_demo3.MMPojo3.Builder setSize(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public data_demo3.MMPojo3.Builder clearSize() {
      size = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public data_demo3.MMPojo3.Builder setSubject(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public data_demo3.MMPojo3.Builder clearSubject() {
      subject = null;
    ...
    public MMPojo3 build() {
      try {
        MMPojo3 record = new MMPojo3();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<MMPojo3>
    WRITER$ = (org.apache.avro.io.DatumWriter<MMPojo3>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<MMPojo3>
    READER$ = (org.apache.avro.io.DatumReader<MMPojo3>)MODEL$.createDatumReader(SCHEMA$);
